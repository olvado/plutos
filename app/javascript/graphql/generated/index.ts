...
export type CreateAccountMutation = { __typename?: 'Mutation', createAccount?: { __typename?: 'CreateAccountPayload', errors: Array<string>, account?: { __typename?: 'Account', id: number, name: string, accountType: AccountTypeEnum, accountNumber: string, sortCode: string, dateOpened: any } | null } | null };
...
export type UpdateAccountMutation = { __typename?: 'Mutation', updateAccount?: { __typename?: 'UpdateAccountPayload', errors: Array<string>, account?: { __typename?: 'Account', id: number, name: string, dateClosed?: any | null } | null } | null };
...
export type CreateTransactionMutation = { __typename?: 'Mutation', createTransaction?: { __typename?: 'CreateTransactionPayload', errors: Array<string>, transaction?: { __typename?: 'Transaction', id: number, type: TransactionTypeEnum, description?: string | null, amount: number, date: any } | null } | null };
...
export type UpdateTransactionMutation = { __typename?: 'Mutation', updateTransaction?: { __typename?: 'UpdateTransactionPayload', errors: Array<string>, transaction?: { __typename?: 'Transaction', id: number, type: TransactionTypeEnum, description?: string | null, amount: number, date: any } | null } | null };
...
export type DeleteTransactionMutation = { __typename?: 'Mutation', deleteTransaction?: { __typename?: 'DeleteTransactionPayload', success: boolean, errors: Array<string> } | null };
...
export type UpdateProfileMutation = { __typename?: 'Mutation', updateProfile?: { __typename?: 'UpdateProfilePayload', errors: Array<string>, user?: { __typename?: 'User', id: number, name: string, email: string } | null } | null };

export type GetAccountsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetAccountsQuery = { __typename?: 'Query', accounts: Array<{ __typename?: 'Account', id: number, name: string, accountType: AccountTypeEnum, accountNumber: string, sortCode: string, dateOpened: any, dateClosed?: any | null, balance?: { __typename?: 'AccountBalance', totalDeposits: number, totalWithdrawals: number, totalVariance: number, totalInterest: number, balance: number } | null, monthlySummaries: Array<{ __typename?: 'AccountMonthlySummary', month: any, netChange: number }> }> };
...
export type GetRecentTransactionsQuery = { __typename?: 'Query', recentTransactions: Array<{ __typename?: 'Transaction', id: number, type: TransactionTypeEnum, description?: string | null, amount: number, date: any, accountId: number }> };
...
export type GetAccountQuery = { __typename?: 'Query', account: { __typename?: 'Account', id: number, name: string, accountType: AccountTypeEnum, accountNumber: string, sortCode: string, dateOpened: any, dateClosed?: any | null, transactions: Array<{ __typename?: 'Transaction', id: number, type: TransactionTypeEnum, description?: string | null, amount: number, date: any }>, balance?: { __typename?: 'AccountBalance', totalDeposits: number, totalWithdrawals: number, totalVariance: number, totalInterest: number, balance: number } | null, monthlySummaries: Array<{ __typename?: 'AccountMonthlySummary', month: any, deposits: number, withdrawals: number, variance: number, interest: number, netChange: number }> } };

export type GetMeQueryVariables = Exact<{ [key: string]: never; }>;


export type GetMeQuery = { __typename?: 'Query', me: { __typename?: 'User', id: number, name: string, email: string } };
...
export type GetTransactionsQuery = { __typename?: 'Query', transactions: Array<{ __typename?: 'Transaction', id: number, type: TransactionTypeEnum, description?: string | null, amount: number, date: any }> };
 ...
 * });
 */
export function useGetRecentTransactionsQuery(baseOptions?: Apollo.QueryHookOptions<GetRecentTransactionsQuery, GetRecentTransactionsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetRecentTransactionsQuery, GetRecentTransactionsQueryVariables>(GetRecentTransactionsDocument, options);
      }
export function useGetRecentTransactionsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetRecentTransactionsQuery, GetRecentTransactionsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetRecentTransactionsQuery, GetRecentTransactionsQueryVariables>(GetRecentTransactionsDocument, options);
        }
// @ts-ignore
export function useGetRecentTransactionsSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<GetRecentTransactionsQuery, GetRecentTransactionsQueryVariables>): Apollo.UseSuspenseQueryResult<GetRecentTransactionsQuery, GetRecentTransactionsQueryVariables>;
export function useGetRecentTransactionsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetRecentTransactionsQuery, GetRecentTransactionsQueryVariables>): Apollo.UseSuspenseQueryResult<GetRecentTransactionsQuery | undefined, GetRecentTransactionsQueryVariables>;
export function useGetRecentTransactionsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetRecentTransactionsQuery, GetRecentTransactionsQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetRecentTransactionsQuery, GetRecentTransactionsQueryVariables>(GetRecentTransactionsDocument, options);
        }
...
export type GetRecentTransactionsSuspenseQueryHookResult = ReturnType<typeof useGetRecentTransactionsSuspenseQuery>;
export type GetRecentTransactionsQueryResult = Apollo.QueryResult<GetRecentTransactionsQuery, GetRecentTransactionsQueryVariables>;
...
// @ts-ignore
export function useGetAccountSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<GetAccountQuery, GetAccountQueryVariables>): Apollo.UseSuspenseQueryResult<GetAccountQuery, GetAccountQueryVariables>;
export function useGetAccountSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetAccountQuery, GetAccountQueryVariables>): Apollo.UseSuspenseQueryResult<GetAccountQuery | undefined, GetAccountQueryVariables>;
...
export const GetTransactionsDocument = gql`
    query GetTransactions($accountId: Int!, $type: TransactionTypeEnum, $from: ISO8601DateTime, $to: ISO8601DateTime) {
